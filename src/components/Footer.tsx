      ...
      <div className="container mx-auto px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-gray-600">
              <p className="flex items-center">
                ...
                <span className="ml-2">Churchill Gardens, Acton, London W3 0JN</span>
              </p>
              <p className="flex items-center">
                <span className="font-medium text-primary-600">Phone:</span>
                <span className="ml-2">020 8992 8899</span>
              </p>
              <p className="flex items-center">
                <span className="font-medium text-primary-600">Email:</span>
                <span className="ml-2">info@westactoncentre.co.uk</span>
              </p>
              <p className="flex items-center">
                <span className="font-medium text-primary-600">Website:</span>
                <span className="ml-2">www.westactoncentre.co.uk</span>
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                <a
                  href="https://www.facebook.com/WestActonCommunityCentre"
                  target="_blank"
        ...
        <div className="text-center py-8 border-t border-gray-200 mt-12">
          ...
          <p className="text-gray-500 text-xs">
            © {new Date().getFullYear()} West Acton Community Centre. 
